...
cbuffer Material : register(b2) {
    ...
    float emission;
    float alpha_clip;
    float specular;             // Specular multiplier for F0
...
PSOutput PSMain(PSInput input) {
    ...
    float ao = 1.0;
    float emission_val = emission;  // Default emission from material
    ...
    output.material_emission = float4(metallic_val, emission_val, specular, 0.0);
