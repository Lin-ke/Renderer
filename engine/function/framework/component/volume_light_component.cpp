...
VolumeLightComponent::~VolumeLightComponent() {
    /* //####TODO####
    if (!EngineContext::destroyed() && volume_light_id_ != 0) {
        // EngineContext::render_resource()->release_volume_light_id(volume_light_id_);
    }
    */
}
...
void VolumeLightComponent::on_init() {
    // Component::on_init();
    // volume_light_id_ = EngineContext::render_resource()->allocate_volume_light_id(); //####TODO####
}
...
void VolumeLightComponent::update_light_info() {
    ...
    // EngineContext::render_resource()->set_volume_light_info(info_, volume_light_id_); //####TODO####
}

void VolumeLightComponent::update_texture() {
    // ... logic to create textures using RHI ...
    // EngineContext::render_resource()->set_volume_light_textures(textures_, volume_light_id_); //####TODO####
}
