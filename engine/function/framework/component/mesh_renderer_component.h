...
public:
    ...
    // Asset dependencies - automatically generates load/save/traverse methods
    ASSET_DEPS(
        (ModelRef, model_),
...
private:
    ...
    // ASSET_DEPS macro declares: ModelRef model_; std::vector<MaterialRef> materials_;
    ...
    void serialize(Archive& ar) {
        serialize_deps(ar);  // Generated by ASSET_DEPS macro
