...
void Material::on_load_asset() {
    ...
    // (loading may change vector sizes based on serialized data)
...
void Material::update() {
    ...
    // Set texture IDs (0 means invalid/unbound in bindless system)
    ...
    INFO(LogMaterial, "Material updated: id={}, diffuse=({},{},{},{}), roughness={}, metallic={}",
         material_id_, diffuse_.x(), diffuse_.y(), diffuse_.z(), diffuse_.w(), roughness_, metallic_);
}
